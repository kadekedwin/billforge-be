    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $business->receiptSettings()->create([
                ...
                'label_transaction_id_enabled' => true,
                'label_date' => 'Date',
                'label_date_enabled' => true,
                'label_time' => 'Time',
                'label_time_enabled' => true,
                'label_cashier' => 'Cashier',
                'label_cashier_enabled' => true,
                'label_customer' => 'Customer',
                'label_customer_enabled' => true,
                'label_items' => 'Items',
                'label_items_enabled' => true,
                'label_subtotal' => 'Subtotal',
                'label_subtotal_enabled' => true,
                'label_discount' => 'Discount',
                'label_discount_enabled' => true,
                'label_tax' => 'Tax',
                'label_tax_enabled' => true,
                'label_total' => 'Total',
                'label_total_enabled' => true,
                'label_payment_method' => 'Payment Method',
                'label_payment_method_enabled' => true,
